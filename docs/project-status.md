...
- 新克隆包含五款固定源码版本的内置游戏：疯狂点击、你画我猜、估个大概、谁是卧底、即刻落槌。
...
- Vitest 覆盖平台恢复和四款游戏的关键规则；Playwright 覆盖阻断公网后的双手机初始开局、控制器刷新恢复、三人连续启动并切换全部四款内置游戏，以及两人不能选择谁是卧底。（即刻落槌为新游戏，测试用例待补。）
...
- `auction-king`（即刻落槌）：2–4 人，三轮暗拍博弈；每轮展示神秘拍品及渐进线索，玩家从固定出价档位中密封出价，落槌时揭示真价并结算盈亏。

五款游戏均为 alpha，仍需要真人聚会测试来调整节奏、难度、题库质量和移动端误触。
