...
- `bullshit`：2–52 人；使用无大小王的 52 张牌，服务端保管私人手牌、固定宣称点数、每堆一次过牌、只检查最近一手以及待确认胜利；控制器提供原创像素木桌、弧形手牌、按点数/花色理牌、居中动态牌堆、翻面飞牌、全屏 Check 冲击动效以及不透传服务端叙述的精简玩家文案；手机端支持横竖屏自适应，手牌命中区与牌面精确对齐，保证不低于 44px 的触控目标。
...
八款游戏均为 alpha，仍需要真人聚会测试来调整节奏、难度、题库质量、命运轮盘时长和移动端误触；吹牛牌还需要重点验证极端长手牌时的大人数主屏可读性，迷雾仓库需要重点验证横屏信息密度和五轮估值节奏。
