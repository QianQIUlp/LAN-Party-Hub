...
- `auction-king`（迷雾仓库）：2–6 人；仓库总价限制为 30–100 万，约 70% 的局落在以 45 万为峰值的低价区、约 30% 落在以 85 万为峰值的高价区；系统仅在第 1、3 轮提供保守公共提示，其余情报来自私人角色与仪器；达到当轮领先倍率即可提前成交，手机控制器为横屏专用的主要操作界面。
