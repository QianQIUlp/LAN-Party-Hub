...
- Bundled four games at fixed upstream revisions so source and Windows releases are reproducible and do not clone game repositories during a build.
...
- Added authoritative input validation and corrected private-state handling, including keeping the Imposter secret away from the imposter player.
